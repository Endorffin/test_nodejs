...
export declare class OrganizationWebhooks extends CrowdinApi {
     ...
     */
    addWebhook(request: OrganizationWebhooksModel.AddWebhookRequest): Promise<ResponseObject<OrganizationWebhooksModel.Webhook>>;
    /**
     ...
     */
    editWebhook(webhookId: number, request: PatchRequest[]): Promise<ResponseObject<OrganizationWebhooksModel.Webhook>>;
}
export declare namespace OrganizationWebhooksModel {
    ...
    type Event = 'project.created' | 'project.deleted' | 'group.created' | 'group.deleted';
